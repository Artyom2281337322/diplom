        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h2>Создание задания для урока "{{ $lesson->title }}"</h2>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.tasks.store', $lesson) }}">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Исходный HTML (initial_html) – показывается ученику в редакторе</label>
                            <textarea name="initial_html" class="form-control font-monospace" rows="6">{{ old('initial_html') }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Исходный CSS (initial_css) – показывается ученику в редакторе</label>
                            <textarea name="initial_css" class="form-control font-monospace" rows="6">{{ old('initial_css') }}</textarea>
                        </div>
                        ...
                        <div class="card bg-light mb-3">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea id="ref_html" class="form-control font-monospace" rows="6">{{ old('ref_html') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="ref_css" class="form-control font-monospace" rows="6">{{ old('ref_css') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="validation_rules" id="validation_rules" class="form-control font-monospace" rows="8">{{ old('validation_rules', '{}') }}</textarea>
                        </div>
